                        ...
                        <div class="row g-4 align-items-center">
                            ...
                            <div class="col-sm-auto">
                                <div>
                                    ...
                                    <button type="button" class="btn btn-success add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i> Ajouter un marchand</button>
                                    {{-- <button type="button" class="btn btn-info"><i class="ri-file-download-line align-bottom me-1"></i> Importer</button> --}}
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row g-3">
                                <div class="col-xl-6">
                                    <div class="search-box">
                                        <input type="text" class="form-control search" placeholder="Search for merchant_name or merchant_code...">
                            ...
                            {{-- <div class="table-responsive table-card mb-1"> --}}
                                <table class="display table table-bordered" id="buttons-datatables" style="width:100%">
                                    <thead class="table-light text-muted">
                                        <tr>
                                            ...
                                            <th class="sort" data-sort="merchant_name" style="display:none;">Merchant_name</th>
                                            <th class="sort" data-sort="merchant_name">Merchant_name</th>
                                            <th class="sort" data-sort="merchant_phone">Merchant_phone</th>
                                            <th class="sort" data-sort="merchant_code">Merchant_code</th>
                                            <th class="sort" data-sort="merchant_id">Merchant_id</th>
                                            <th class="sort" data-sort="merchant_status">Status</th>
                                    ...
                                    <tbody class="list form-check-all">
                                        ...
                                        <tr>
                                            ...
                                            {{-- <td>{{++$key}}</td> --}}
                                            <td class="merchant_name">{{ $item->merchant_name }}</td>
                                            <td class="merchant_phone">{{ $item->merchant_phone }}</td>
                                            <td class="merchant_code">{{ $item->merchant_code }}</td>
                                            <td class="merchant_id">{{ $item->merchant_id }}</td>
                                            <td class="merchant_status text-center"><span class="badge badge-soft-success text-uppercase">Active</span>
                                            </td>
                                            <td>
                                                <ul class="list-inline hstack gap-2 mb-0">
                                                    <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                                                        <a href="#showModal" data-bs-toggle="modal" class="text-success d-inline-block edit-item-btn">
                                ...
                                <div class="noresult" style="display: none">
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mb-0">We've searched more than 1+ merchant We did not find any merchant for you search.</p>
                                    </div>
                                </div>
                            {{-- </div> --}}
